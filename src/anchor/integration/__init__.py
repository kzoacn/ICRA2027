...
the formal Planning child imports policy-side integration submodules inside a
...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ContactAwarePlanningController": (".adapters", "ContactAwarePlanningController"),
    ...
    "LiberoPlanningRobot": (".adapters", "LiberoPlanningRobot"),
    "OSCWaypointConfig": (".adapters", "OSCWaypointConfig"),
    "AnchorPolicy": (".adapters", "AnchorPolicy"),
    ...
    "to_anchor_observation": (".adapters", "to_anchor_observation"),
