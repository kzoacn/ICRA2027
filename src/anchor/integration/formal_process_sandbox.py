"""Bubblewrap projection and runtime evidence for formal Planning policy code."""
...
SANDBOX_HOSTNAME = "libero-planning-policy"

POLICY_SOURCE_FILES = (
    "anchor/__init__.py",
    "anchor/common/__init__.py",
    "anchor/common/camera_geometry.py",
    "anchor/common/grasp_journal.py",
    "anchor/common/observation.py",
    "anchor/common/pan_affordance.py",
    "anchor/common/policy.py",
    "anchor/contact/__init__.py",
    "anchor/contact/compiler.py",
    "anchor/contact/controller.py",
    "anchor/contact/detectors.py",
    "anchor/contact/schema.py",
    "anchor/integration/__init__.py",
    "anchor/integration/adapters.py",
    "anchor/integration/cavity.py",
    "anchor/integration/components.py",
    "anchor/integration/formal_process_sandbox.py",
    "anchor/integration/formal_process_transport.py",
    "anchor/integration/planning_process.py",
    "anchor/integration/policy_ipc.py",
    "anchor/integration/policy_result.py",
    "anchor/integration/planning_policy_runtime.py",
    "anchor/perception/__init__.py",
    "anchor/perception/adapters.py",
    "anchor/perception/fusion.py",
    "anchor/perception/gallery.py",
    "anchor/perception/geometry.py",
    "anchor/perception/grounding_dino.py",
    "anchor/perception/pipeline.py",
    "anchor/perception/schema.py",
    "anchor/manipulation/__init__.py",
    "anchor/manipulation/controller.py",
    "anchor/manipulation/models.py",
    "anchor/manipulation/perception.py",
    "anchor/manipulation/task_compiler.py",
    "anchor/planning/__init__.py",
    "anchor/planning/compiler.py",
    "anchor/planning/controller.py",
    "anchor/planning/grasp.py",
    "anchor/planning/optimizer.py",
    "anchor/planning/perception.py",
    "anchor/planning/schema.py",
    "anchor/planning/sdf.py",
    "anchor/planning/sequential.py",
    "anchor/planning/task_planner.py",
)

EXCLUDED_POLICY_FILES = (
    "anchor/common/env_adapter.py",
    "anchor/common/runner.py",
    "anchor/integration/campaign_manifest.py",
    "anchor/integration/campaign_plan.py",
    "anchor/integration/cli.py",
    "anchor/integration/config.py",
    "anchor/integration/evaluator.py",
    "anchor/integration/formal_provenance.py",
    "anchor/integration/results.py",
    "anchor/integration/video.py",
    "anchor/integration/video_audit.py",
)
...
def _gallery_files(asset_root: Path) -> tuple[Path, ...]:
    from anchor.perception.gallery import PUBLIC_ASSET_GALLERY_SPECS
...
class SandboxProjection:
    ...
    def create(
        ...
        *,
        ...
        root = Path(tempfile.mkdtemp(prefix="libero-planning-sandbox-", dir="/tmp"))
        ...
        try:
            ...
            clock_gate = validate_policy_runtime_clock_source(
                policy_root / "anchor/integration/planning_policy_runtime.py"
            )
            ...
            (identity_root / "passwd").write_text(
                "nobody:x:65534:65534:Planning policy:/tmp:/usr/sbin/nologin\n",
                encoding="utf-8",
            )
            ...
            if perception_backend in {"auto", "grounding-dino"} and model_path is None:
                from anchor.perception.grounding_dino import (
    ...
    def cleanup(self) -> None:
        ...
        if not root.name.startswith("libero-planning-sandbox-") or root.parent != Path(
            "/tmp"
        ):
