...
DEFAULT_MAX_STEPS = {
    ...
    # running.  Formal ANCHOR/planning evaluation therefore uses one fixed horizon
...
def configure_runtime_environment() -> None:
    ...
    os.environ.setdefault("LIBERO_CONFIG_PATH", str(workspace / "runtime" / "libero"))
    os.environ.setdefault("MUJOCO_GL", "osmesa")
    os.environ.setdefault("PYOPENGL_PLATFORM", "osmesa")
    os.environ.setdefault("NUMBA_CACHE_DIR", "/tmp/anchor-numba")
    ...
    os.environ.setdefault("MPLCONFIGDIR", "/tmp/anchor-matplotlib")
