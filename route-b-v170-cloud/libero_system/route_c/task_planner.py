"""Strict instruction-only high-level planning for Route C.
...
PLANNER_SCHEMA_VERSION = "route-c.instruction-plan.v1"
...
class RouteCTaskPlanner:
    ...
    def compile(self, instruction: str) -> TaskPlan:
        """Compiler-style alias for callers that already use Route C compilers."""
