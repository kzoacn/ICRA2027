"""Strict, serialisable schema for Route C constraint graphs.
...
SCHEMA_VERSION = "route-c.constraint-graph.v1"


class SchemaError(ValueError):
    """Raised when a graph is outside the executable Route C language."""
