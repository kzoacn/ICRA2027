"""Thin Route-B / Route-C bridges around the neutral sensor-only API.
...
def _drawer_handle_consistent_candidates(
    ...
    from libero_system.common import CameraCalibration, CameraFrame
    from libero_system.goal_skills.detectors import DrawerHandleDetector
...
def coerce_rgbd_frame(
    ...
    *,
    ...
    """Convert neutral, Route-B, Route-C, or equivalent duck-typed RGB-D frames."""
...
class RouteBScenePerceptionAdapter:
    """Implements ``route_b.perception.ScenePerception`` without oracle data."""
    ...
    def _fresh_surface_points(
        ...
        """Return current-frame DINO RGB-D points for one Route-B object.
    ...
    def _snapshot(
        ...
        *,
        ...
        from libero_system.route_b.models import SceneObject, SceneSnapshot
    ...
    def refine_carried_mug(self, observation: Any, source):
        ...
        from ..route_b.models import SceneObject
...
class RouteCSceneEstimatorAdapter:
    """Implements Route C's provider-style ``SceneEstimator`` protocol."""
    ...
    def _tracked_instances(
        ...
        # Retain unmatched requested tracks through gripper occlusion.  Route C
    ...
    def _observe(
        ...
        *,
        ...
        from libero_system.route_c.schema import EntityRef, Relation
        from libero_system.route_c.sdf import BoxSDF, CompositeSDF, EmptySDF
        ...
        dino = _dino_instances(
            ...
            # Route C's narrowly scoped released-hand self-field proof needs
        ...
        # the normal Route-C resolver remains responsible for accepting a
        ...
        for label in normalized_requested:
            ...
            if not gated and label in force_dino:
                # Mirror Route B's sensor-only fallback for small references:
        ...
        # Route C requests source-selector references alongside source/target.
        ...
        # stove in both top-down crops.  Route C must not invent the missing
